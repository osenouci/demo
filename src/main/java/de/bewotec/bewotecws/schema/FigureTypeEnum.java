...
/**
 * <p>Java class for FigureTypeEnum.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="FigureTypeEnum">
...
public enum FigureTypeEnum {
    ...
    public static FigureTypeEnum fromValue(String v) {
        for (FigureTypeEnum c: FigureTypeEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
