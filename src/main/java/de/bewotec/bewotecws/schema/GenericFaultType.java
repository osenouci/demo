 ...
 *       &lt;sequence>
 *         &lt;element name="ErrorCode" type="{http://www.bewotec.de/bewotecws/Schema}ErrorCodeEnum" minOccurs="0"/>
...
public class GenericFaultType {
    ...
    @XmlElementRef(name = "ErrorMessage", namespace = "http://www.bewotec.de/bewotecws/Schema", type = JAXBElement.class, required = false)
    protected JAXBElement<String> errorMessage;
    @XmlElementRef(name = "PlayerName", namespace = "http://www.bewotec.de/bewotecws/Schema", type = JAXBElement.class, required = false)
