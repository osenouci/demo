...
/**
 *  AddOnType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class AddOnType implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * field for StartDateOffset
     */
    protected int localStartDateOffset;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localStartDateOffsetTracker = false;

    /**
     * field for EndDateOffset
     */
    protected int localEndDateOffset;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localEndDateOffsetTracker = false;
    ...
    public boolean isStartDateOffsetSpecified() {
        return localStartDateOffsetTracker;
    }
    ...
    public int getStartDateOffset() {
        return localStartDateOffset;
    }

    /**
     * Auto generated setter method
     * @param param StartDateOffset
     */
    public void setStartDateOffset(int param) {
        // setting primitive attribute tracker to true
        localStartDateOffsetTracker = param != java.lang.Integer.MIN_VALUE;

        this.localStartDateOffset = param;
    }

    public boolean isEndDateOffsetSpecified() {
        return localEndDateOffsetTracker;
    }
    ...
    public int getEndDateOffset() {
        return localEndDateOffset;
    }

    /**
     * Auto generated setter method
     * @param param EndDateOffset
     */
    public void setEndDateOffset(int param) {
        // setting primitive attribute tracker to true
        localEndDateOffsetTracker = param != java.lang.Integer.MIN_VALUE;

        this.localEndDateOffset = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":AddOnType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "AddOnType", xmlWriter);
        ...
        if (localStartDateOffsetTracker) {
            namespace = "http://www.bewotec.de/bewotecws/Schema";
            writeStartElement(null, namespace, "StartDateOffset", xmlWriter);

            if (localStartDateOffset == java.lang.Integer.MIN_VALUE) {
                throw new org.apache.axis2.databinding.ADBException(
                    "StartDateOffset cannot be null!!");
            } else {
                xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                        localStartDateOffset));
            }

            xmlWriter.writeEndElement();
        }

        if (localEndDateOffsetTracker) {
            namespace = "http://www.bewotec.de/bewotecws/Schema";
            writeStartElement(null, namespace, "EndDateOffset", xmlWriter);

            if (localEndDateOffset == java.lang.Integer.MIN_VALUE) {
                throw new org.apache.axis2.databinding.ADBException(
                    "EndDateOffset cannot be null!!");
            } else {
                xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                        localEndDateOffset));
            }
    ...
    public static class Factory {
         ...
         */
        public static AddOnType parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            AddOnType object = new AddOnType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AddOnType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AddOnType) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.bewotec.de/bewotecws/Schema", "Included").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "Included" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setIncluded(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.bewotec.de/bewotecws/Schema",
                            "StartDateOffset").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "StartDateOffset" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setStartDateOffset(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            content));
                    ...
                    object.setStartDateOffset(java.lang.Integer.MIN_VALUE);
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.bewotec.de/bewotecws/Schema",
                            "EndDateOffset").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "EndDateOffset" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setEndDateOffset(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            content));
                    ...
                    object.setEndDateOffset(java.lang.Integer.MIN_VALUE);
                }
