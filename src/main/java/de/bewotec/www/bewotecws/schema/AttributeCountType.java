...
/**
 *  AttributeCountType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class AttributeCountType implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = AttributeCountType
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":AttributeCountType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "AttributeCountType", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static AttributeCountType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AttributeCountType object = new AttributeCountType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AttributeCountType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AttributeCountType) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
