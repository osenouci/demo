...
public class AvailabilityResponseType implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Rooms
     */
    protected de.bewotec.www.bewotecws.schema.Rooms_type2 localRooms;

    /**
     * field for Boards
     */
    protected de.bewotec.www.bewotecws.schema.Boards_type3 localBoards;
     ...
     * field for Durations
     */
    protected de.bewotec.www.bewotecws.schema.Durations_type2 localDurations;
    ...
    /**
     * Auto generated getter method
     * @return de.bewotec.www.bewotecws.schema.Rooms_type2
     */
    public de.bewotec.www.bewotecws.schema.Rooms_type2 getRooms() {
        return localRooms;
    }
     ...
     * @param param Rooms
     */
    public void setRooms(de.bewotec.www.bewotecws.schema.Rooms_type2 param) {
        this.localRooms = param;
    }

    /**
     * Auto generated getter method
     * @return de.bewotec.www.bewotecws.schema.Boards_type3
     */
    public de.bewotec.www.bewotecws.schema.Boards_type3 getBoards() {
        return localBoards;
    }
     ...
     * @param param Boards
     */
    public void setBoards(de.bewotec.www.bewotecws.schema.Boards_type3 param) {
    ...
    public void setDepartureAirports(
        ...
        localDepartureAirportsTracker = param != null;
    ...
    public void setArrivalAirports(
        de.bewotec.www.bewotecws.schema.AirportListType param) {
        localArrivalAirportsTracker = param != null;
    ...
    /**
     * Auto generated getter method
     * @return de.bewotec.www.bewotecws.schema.Durations_type2
     */
    public de.bewotec.www.bewotecws.schema.Durations_type2 getDurations() {
    ...
    public void setDurations(
        de.bewotec.www.bewotecws.schema.Durations_type2 param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":AvailabilityResponseType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        localBoards.serialize(new javax.xml.namespace.QName(
                "http://www.bewotec.de/bewotecws/Schema", "Boards"), xmlWriter);

        if (localDepartureAirportsTracker) {
            if (localDepartureAirports == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "DepartureAirports cannot be null!!");
            }
        ...
        if (localArrivalAirportsTracker) {
            if (localArrivalAirports == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "ArrivalAirports cannot be null!!");
            }

            localArrivalAirports.serialize(new javax.xml.namespace.QName(
                    "http://www.bewotec.de/bewotecws/Schema", "ArrivalAirports"),
                xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static AvailabilityResponseType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AvailabilityResponseType object = new AvailabilityResponseType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AvailabilityResponseType".equals(type)) {
                            ...
                            return (AvailabilityResponseType) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.bewotec.de/bewotecws/Schema", "Month").equals(
                            reader.getName())) {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.bewotec.de/bewotecws/Schema", "Year").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            ...
                            reader.getName())) {
                    object.setRooms(de.bewotec.www.bewotecws.schema.Rooms_type2.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            ...
                            reader.getName())) {
                    object.setBoards(de.bewotec.www.bewotecws.schema.Boards_type3.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setDurations(de.bewotec.www.bewotecws.schema.Durations_type2.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.bewotec.de/bewotecws/Schema", "Count").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
