...
/**
 *  CodeNameType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CodeNameType implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":CodeNameType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "CodeNameType", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CodeNameType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CodeNameType object = new CodeNameType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CodeNameType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CodeNameType) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
