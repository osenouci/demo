...
/**
 *  CountryType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CountryType implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":CountryType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "CountryType", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CountryType parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            CountryType object = new CountryType();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CountryType".equals(type)) {
                            ...
                            return (CountryType) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
