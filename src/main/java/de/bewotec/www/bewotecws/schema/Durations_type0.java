...
/**
 *  Durations_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Durations_type0 implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = Durations_type0
     ...
     */
    protected void validateDuration(java.lang.String[] param) {
    }
     ...
     */
    public void addDuration(java.lang.String param) {
        if (localDuration == null) {
            localDuration = new java.lang.String[] {  };
        }

        //update the setting tracker
        localDurationTracker = true;

        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localDuration);
        list.add(param);
        this.localDuration = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Durations_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Durations_type0", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Durations_type0 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Durations_type0 object = new Durations_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Durations_type0".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Durations_type0) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setDuration((java.lang.String[]) list1.toArray(
