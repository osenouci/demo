...
/**
 *  Durations_type1 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Durations_type1 implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = Durations_type1
     ...
     */
    protected void validateDuration(int[] param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Durations_type1", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Durations_type1", xmlWriter);
            }
        }
        ...
        if (localDuration != null) {
            ...
            for (int i = 0; i < localDuration.length; i++) {
                if (localDuration[i] != java.lang.Integer.MIN_VALUE) {
    ...
    public static class Factory {
         ...
         */
        public static Durations_type1 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Durations_type1 object = new Durations_type1();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Durations_type1".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Durations_type1) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setDuration((int[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            int.class, list1));
