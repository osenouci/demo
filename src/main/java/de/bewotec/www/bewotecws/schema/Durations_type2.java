...
/**
 *  Durations_type2 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Durations_type2 implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = Durations_type2
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Durations_type2", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Durations_type2", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Durations_type2 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Durations_type2 object = new Durations_type2();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Durations_type2".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Durations_type2) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
