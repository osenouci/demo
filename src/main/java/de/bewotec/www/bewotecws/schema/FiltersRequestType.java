...
/**
 *  FiltersRequestType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class FiltersRequestType extends de.bewotec.www.bewotecws.schema.ProductRequestType
    implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = FiltersRequestType
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":FiltersRequestType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "FiltersRequestType", xmlWriter);
        }
        ...
        if (localFilterTracker) {
            ...
            localFilter.serialize(new javax.xml.namespace.QName(
                    "http://www.bewotec.de/bewotecws/Schema", "Filter"),
                xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static FiltersRequestType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            FiltersRequestType object = new FiltersRequestType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"FiltersRequestType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (FiltersRequestType) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
