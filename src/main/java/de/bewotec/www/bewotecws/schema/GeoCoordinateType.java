...
/**
 *  GeoCoordinateType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GeoCoordinateType implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GeoCoordinateType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GeoCoordinateType", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GeoCoordinateType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GeoCoordinateType object = new GeoCoordinateType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GeoCoordinateType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GeoCoordinateType) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.bewotec.de/bewotecws/Schema", "Latitude").equals(
                            reader.getName())) {
                    ...
                    object.setLatitude(org.apache.axis2.databinding.utils.ConverterUtil.convertToFloat(
                            content));
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setLongitude(org.apache.axis2.databinding.utils.ConverterUtil.convertToFloat(
                            content));
