...
/**
 *  GroupIds_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GroupIds_type0 implements org.apache.axis2.databinding.ADBBean {
    ...
    public void addGroupId(java.lang.String param) {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localGroupId);
        list.add(param);
        this.localGroupId = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GroupIds_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GroupIds_type0", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GroupIds_type0 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GroupIds_type0 object = new GroupIds_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GroupIds_type0".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GroupIds_type0) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.bewotec.de/bewotecws/Schema", "GroupId").equals(
                            reader.getName())) {
                    ...
                    object.setGroupId((java.lang.String[]) list1.toArray(
