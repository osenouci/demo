...
/**
 *  GroupRequestType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GroupRequestType extends de.bewotec.www.bewotecws.schema.ProductRequestType
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":GroupRequestType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "GroupRequestType", xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static GroupRequestType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GroupRequestType object = new GroupRequestType();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GroupRequestType".equals(type)) {
                            ...
                            return (GroupRequestType) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
