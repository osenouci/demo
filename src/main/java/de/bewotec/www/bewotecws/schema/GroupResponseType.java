...
/**
 *  GroupResponseType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GroupResponseType extends de.bewotec.www.bewotecws.schema.BaseResponseType
    implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = GroupResponseType
     ...
     */
    protected de.bewotec.www.bewotecws.schema.ProductGroupType localProductGroups;
     ...
     */
    public de.bewotec.www.bewotecws.schema.ProductGroupType getProductGroups() {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":GroupResponseType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "GroupResponseType", xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static GroupResponseType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GroupResponseType object = new GroupResponseType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GroupResponseType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GroupResponseType) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        object.setProductGroups(de.bewotec.www.bewotecws.schema.ProductGroupType.Factory.parse(
                                reader));
