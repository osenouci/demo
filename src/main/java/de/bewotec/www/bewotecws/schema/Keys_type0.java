...
/**
 *  Keys_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Keys_type0 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Keys_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Keys_type0", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Keys_type0 parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Keys_type0 object = new Keys_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Keys_type0".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Keys_type0) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement()) {
                    ...
                    org.apache.axiom.om.OMNamespace omNs = fac.createOMNamespace("http://www.bewotec.de/bewotecws/Schema",
                            "");
                    org.apache.axiom.om.OMElement _valueKey = fac.createOMElement("Key",
                            omNs);
