...
/**
 *  PeriodEmptyStayType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class PeriodEmptyStayType implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = PeriodEmptyStayType
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":PeriodEmptyStayType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "PeriodEmptyStayType", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static PeriodEmptyStayType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PeriodEmptyStayType object = new PeriodEmptyStayType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PeriodEmptyStayType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (PeriodEmptyStayType) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
