...
/**
 *  PriceRequestType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class PriceRequestType implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = PriceRequestType
     ...
     * field for MinAmount
     */
    protected java.math.BigDecimal localMinAmount;
     ...
     */
    protected de.bewotec.www.bewotecws.schema.PriceTypes_type2 localPriceTypes;
    ...
    /**
     * field for FullpayerPriceOnly
     */
    protected boolean localFullpayerPriceOnly;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localFullpayerPriceOnlyTracker = false;
     ...
     */
    public void setMinAmount(java.math.BigDecimal param) {
    ...
    /**
     * Auto generated getter method
     * @return de.bewotec.www.bewotecws.schema.PriceTypes_type2
     */
    public de.bewotec.www.bewotecws.schema.PriceTypes_type2 getPriceTypes() {
    ...
    public void setPriceTypes(
        de.bewotec.www.bewotecws.schema.PriceTypes_type2 param) {
        localPriceTypesTracker = param != null;

        this.localPriceTypes = param;
    }

    public boolean isFullpayerPriceOnlySpecified() {
        return localFullpayerPriceOnlyTracker;
    }
     ...
     * @return boolean
     */
    public boolean getFullpayerPriceOnly() {
        return localFullpayerPriceOnly;
    }

    /**
     * Auto generated setter method
     * @param param FullpayerPriceOnly
     */
    public void setFullpayerPriceOnly(boolean param) {
        // setting primitive attribute tracker to true
        localFullpayerPriceOnlyTracker = true;

        this.localFullpayerPriceOnly = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":PriceRequestType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "PriceRequestType", xmlWriter);
            }
        }
        ...
        if (localFullpayerPriceOnlyTracker) {
            namespace = "http://www.bewotec.de/bewotecws/Schema";
            writeStartElement(null, namespace, "FullpayerPriceOnly", xmlWriter);

            if (false) {
                throw new org.apache.axis2.databinding.ADBException(
                    "FullpayerPriceOnly cannot be null!!");
            } else {
                xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                        localFullpayerPriceOnly));
            }
    ...
    public static class Factory {
         ...
         */
        public static PriceRequestType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PriceRequestType object = new PriceRequestType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PriceRequestType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (PriceRequestType) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.bewotec.de/bewotecws/Schema",
                            "MinAmount").equals(reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "MinAmount" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setMinAmount(org.apache.axis2.databinding.utils.ConverterUtil.convertToDecimal(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.bewotec.de/bewotecws/Schema",
                            "MaxAmount").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "MaxAmount" + "  cannot be null");
                    }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setPriceTypes(de.bewotec.www.bewotecws.schema.PriceTypes_type2.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.bewotec.de/bewotecws/Schema",
                            "FullpayerPriceOnly").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "FullpayerPriceOnly" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setFullpayerPriceOnly(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                            content));
