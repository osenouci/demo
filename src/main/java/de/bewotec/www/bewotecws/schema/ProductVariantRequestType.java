/**
 * ProductVariantRequestType.java
 *
...
/**
 *  ProductVariantRequestType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ProductVariantRequestType extends de.bewotec.www.bewotecws.schema.ProductRequestType
    implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ProductVariantRequestType
     ...
     * field for Variant
     */
    protected de.bewotec.www.bewotecws.schema.VariantEnum localVariant;

    /**
     * field for VariantPerProduct
     */
    protected boolean localVariantPerProduct;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localVariantPerProductTracker = false;

    /**
     * field for SecondVariant
     */
    protected de.bewotec.www.bewotecws.schema.VariantEnum localSecondVariant;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localSecondVariantTracker = false;

    /**
     * Auto generated getter method
     * @return de.bewotec.www.bewotecws.schema.VariantEnum
     */
    public de.bewotec.www.bewotecws.schema.VariantEnum getVariant() {
        return localVariant;
    }
     ...
     * @param param Variant
     */
    public void setVariant(de.bewotec.www.bewotecws.schema.VariantEnum param) {
        this.localVariant = param;
    }

    public boolean isVariantPerProductSpecified() {
        return localVariantPerProductTracker;
    }
     ...
     * @return boolean
     */
    public boolean getVariantPerProduct() {
        return localVariantPerProduct;
    }

    /**
     * Auto generated setter method
     * @param param VariantPerProduct
     */
    public void setVariantPerProduct(boolean param) {
        // setting primitive attribute tracker to true
        localVariantPerProductTracker = true;

        this.localVariantPerProduct = param;
    }

    public boolean isSecondVariantSpecified() {
        return localSecondVariantTracker;
    }
     ...
     * @return de.bewotec.www.bewotecws.schema.VariantEnum
     */
    public de.bewotec.www.bewotecws.schema.VariantEnum getSecondVariant() {
        return localSecondVariant;
    }

    /**
     * Auto generated setter method
     * @param param SecondVariant
     */
    public void setSecondVariant(
        de.bewotec.www.bewotecws.schema.VariantEnum param) {
        localSecondVariantTracker = param != null;

        this.localSecondVariant = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":ProductVariantRequestType",
                xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "ProductVariantRequestType", xmlWriter);
        }
        ...
        localVariant.serialize(new javax.xml.namespace.QName(
                "http://www.bewotec.de/bewotecws/Schema", "Variant"), xmlWriter);

        if (localVariantPerProductTracker) {
            namespace = "http://www.bewotec.de/bewotecws/Schema";
            writeStartElement(null, namespace, "VariantPerProduct", xmlWriter);

            if (false) {
                throw new org.apache.axis2.databinding.ADBException(
                    "VariantPerProduct cannot be null!!");
            } else {
                xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                        localVariantPerProduct));
            }

            xmlWriter.writeEndElement();
        }

        if (localSecondVariantTracker) {
            if (localSecondVariant == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "SecondVariant cannot be null!!");
            }

            localSecondVariant.serialize(new javax.xml.namespace.QName(
                    "http://www.bewotec.de/bewotecws/Schema", "SecondVariant"),
                xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static ProductVariantRequestType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ProductVariantRequestType object = new ProductVariantRequestType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ProductVariantRequestType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ProductVariantRequestType) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.bewotec.de/bewotecws/Schema", "Variant").equals(
                            reader.getName())) {
                    object.setVariant(de.bewotec.www.bewotecws.schema.VariantEnum.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.bewotec.de/bewotecws/Schema",
                            "VariantPerProduct").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "VariantPerProduct" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setVariantPerProduct(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.bewotec.de/bewotecws/Schema",
                            "SecondVariant").equals(reader.getName())) {
                    object.setSecondVariant(de.bewotec.www.bewotecws.schema.VariantEnum.Factory.parse(
                            reader));
