...
/**
 *  ValuesRequestType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ValuesRequestType extends de.bewotec.www.bewotecws.schema.BaseRequestType
    implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ValuesRequestType
       Namespace URI = http://www.bewotec.de/bewotecws/Schema
       Namespace Prefix = ns1
     */

    /**
     * field for CriteriaTypes
     */
    protected de.bewotec.www.bewotecws.schema.CriteriaTypes_type0 localCriteriaTypes;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localCriteriaTypesTracker = false;
    ...
    public boolean isCriteriaTypesSpecified() {
        return localCriteriaTypesTracker;
    }

    /**
     * Auto generated getter method
     * @return de.bewotec.www.bewotecws.schema.CriteriaTypes_type0
     */
    public de.bewotec.www.bewotecws.schema.CriteriaTypes_type0 getCriteriaTypes() {
        return localCriteriaTypes;
    }

    /**
     * Auto generated setter method
     * @param param CriteriaTypes
     */
    public void setCriteriaTypes(
        de.bewotec.www.bewotecws.schema.CriteriaTypes_type0 param) {
        localCriteriaTypesTracker = param != null;

        this.localCriteriaTypes = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":ValuesRequestType", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "ValuesRequestType", xmlWriter);
        }
        ...
        if (localCriteriaTypesTracker) {
            if (localCriteriaTypes == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "CriteriaTypes cannot be null!!");
            }

            localCriteriaTypes.serialize(new javax.xml.namespace.QName(
                    "http://www.bewotec.de/bewotecws/Schema", "CriteriaTypes"),
                xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static ValuesRequestType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ValuesRequestType object = new ValuesRequestType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ValuesRequestType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ValuesRequestType) de.bewotec.www.bewotecws.schema.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.bewotec.de/bewotecws/Schema",
                            "CriteriaTypes").equals(reader.getName())) {
                    object.setCriteriaTypes(de.bewotec.www.bewotecws.schema.CriteriaTypes_type0.Factory.parse(
                            reader));
